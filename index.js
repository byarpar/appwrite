...
const client = new Client()
    ...
    .setProject('67150ead0038b4908893')          // Appwrite Project ID
...
// Route to list all function executions
...
// Route to trigger a function using axios
...
// Function to trigger Appwrite function manually
async function triggerAppwriteFunction(functionId) {
    try {
        const response = await axios.post(
            `https://cloud.appwrite.io/v1/functions/${functionId}/executions`,
            {}, // Empty body
...
// Replace 'YOUR_FUNCTION_ID' with actual function ID
triggerAppwriteFunction('YOUR_FUNCTION_ID');
